...
var Header = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: "flex justify-between items-center px-2 py-1.5 rounded-md border border-black border-opacity-10 dark:border-litepie-secondary-700 dark:border-opacity-100 litepie-header" },
...
var Month = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: "flex flex-wrap mt-1.5 litepie-month" }, months.map(function (month, key) { return (React__default["default"].createElement("div", { key: key, className: "w-1/2 px-0.5" },
...
var Week = function (_a) {
    var weeks = _a.weeks;
    return (React__default["default"].createElement("div", { className: "grid grid-cols-7 py-2 mt-0.5 border-b border-black border-opacity-10 dark:text-litepie-secondary-200 dark:border-litepie-secondary-700 dark:border-opacity-100 litepie-week" }, weeks.map(function (day, index) { return (React__default["default"].createElement("div", { key: index },
...
var Year = function (_a) {
    ...
    return (React__default["default"].createElement("div", { className: "flex flex-wrap" }, years.map(function (year, key) { return (React__default["default"].createElement("div", { key: key, className: "w-1/2 px-0.5" },
        React__default["default"].createElement("span", { className: "flex rounded-md mt-1.5" },
            React__default["default"].createElement("button", { type: "button", className: "block w-full px-3 py-2 text-xs font-medium leading-6 tracking-wide uppercase transition-colors bg-white border border-transparent rounded-md 2xl:text-sm text-litepie-secondary-600 hover:bg-litepie-secondary-100 hover:text-litepie-secondary-900 focus:bg-litepie-primary-50 focus:text-litepie-secondary-900 focus:border-litepie-primary-300 focus:ring focus:ring-litepie-primary-500 focus:ring-opacity-10 focus:outline-none dark:bg-litepie-secondary-800 dark:hover:bg-litepie-secondary-700 dark:text-litepie-secondary-300 dark:hover:text-litepie-secondary-100 dark:focus:bg-litepie-secondary-700 litepie-year", onClick: function () { return updateYear(year, asPrevOrNext); } }, year)))); })));
};
...
var Calender = function (_a) {
    ...
    return (React__default["default"].createElement(reactTransitionGroup.TransitionGroup, { classnames: {
        ...
        React__default["default"].createElement("div", { className: "grid grid-cols-7 gap-y-0.5 my-1 litepie-calendar" }, calendar.date().map(function (date, keyDate) {
...
var Shortcut = function (_a) {
    ...
    // }
    //   false;
    React__default["default"].createElement("div", { className: "relative order-last w-full border-t border-b-0 border-black sm:border-t-0 sm:border-b lg:border-b-0 lg:border-r border-opacity-10 sm:order-none dark:border-litepie-secondary-700 dark:border-opacity-100 sm:mt-1 lg:mr-1 sm:mb-1 lg:mb-0 sm:mx-1 lg:mx-0 litepie-shortcut" },
                        ...
                        React__default["default"].createElement("div", { className: "flex flex-wrap lg:flex-nowrap" },
                            ...
                            React__default["default"].createElement("div", { className: "relative flex flex-wrap p-1 sm:flex-nowrap" },
                                asRange() && !asSingle && (React__default["default"].createElement(React__default["default"].Fragment, null,
                                    ...
                                    React__default["default"].createElement("div", { className: "litepie-sections relative w-full sm:w-80".concat(asRange() && !asSingle ? ' mb-3 sm:mb-0 sm:mr-2' : '') },
                                ...
                                asRange() && !asSingle && (React__default["default"].createElement("div", { className: "litepie-sections relative w-full mt-3 overflow-hidden sm:w-80 sm:mt-0 sm:ml-2" },
